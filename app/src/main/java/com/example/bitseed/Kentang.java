...
public class Kentang extends AppCompatActivity {
    ...
    public void getSayur(View view){
        String urlEndPoints = "https://ap-southeast-1.aws.data.mongodb-api.com/app/application-0-srael/endpoint/getAllSayur";
        StringRequest sr = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            JSONObject sayur = resultSayur.getJSONObject(2);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Kentang.this, error.toString().trim(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
