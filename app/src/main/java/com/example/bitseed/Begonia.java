...
public class Begonia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_begonia);
        ...
        StringRequest sr = new StringRequest(
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Begonia.this, error.toString().trim(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
