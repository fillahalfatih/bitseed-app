...
public class ManggaKio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mangga_kio);
        ...
        StringRequest sr = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            JSONObject buah = resultBuah.getJSONObject(0);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(ManggaKio.this, error.toString().trim(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
