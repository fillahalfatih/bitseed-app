...
public final class ActivityKentangBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityKentangBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout heading,
  ...
  @NonNull
  public static ActivityKentangBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityKentangBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_kentang, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityKentangBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityKentangBinding((ConstraintLayout) rootView, heading, kategori, lahan, nama,
          penanaman, persiapan);
    }
