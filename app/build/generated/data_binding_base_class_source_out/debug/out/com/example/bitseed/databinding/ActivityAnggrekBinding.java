...
public final class ActivityAnggrekBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAnggrekBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout heading,
  ...
  @NonNull
  public static ActivityAnggrekBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAnggrekBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_anggrek, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAnggrekBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAnggrekBinding((ConstraintLayout) rootView, heading, kategori, lahan, nama,
          penanaman, persiapan);
    }
