...
public final class ActivityPakcoyBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityPakcoyBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout heading,
  ...
  @NonNull
  public static ActivityPakcoyBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityPakcoyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_pakcoy, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityPakcoyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityPakcoyBinding((ConstraintLayout) rootView, heading, kategori, lahan, nama,
          penanaman, persiapan);
    }
