...
public final class ActivityBegoniaBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityBegoniaBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout heading,
  ...
  @NonNull
  public static ActivityBegoniaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBegoniaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_begonia, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBegoniaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBegoniaBinding((ConstraintLayout) rootView, heading, kategori, lahan, nama,
          penanaman, persiapan);
    }
