...
public final class ActivityLidahMertuaBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityLidahMertuaBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout heading, @NonNull TextView kategori, @NonNull TextView lahan,
      @NonNull TextView nama, @NonNull TextView penanaman, @NonNull TextView persiapan) {
  ...
  @NonNull
  public static ActivityLidahMertuaBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLidahMertuaBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_lidah_mertua, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLidahMertuaBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLidahMertuaBinding((ConstraintLayout) rootView, heading, kategori, lahan,
          nama, penanaman, persiapan);
    }
