...
public final class ActivityWortelBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityWortelBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout heading,
  ...
  @NonNull
  public static ActivityWortelBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityWortelBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_wortel, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityWortelBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityWortelBinding((ConstraintLayout) rootView, heading, kategori, lahan, nama,
          penanaman, persiapan);
    }
